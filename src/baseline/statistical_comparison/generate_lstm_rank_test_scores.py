...
THRESHOLD_PATH = (
	BASELINE_DIR
	/ "raw_error_ranking_threshold.txt"
)
...
def main():
	...
	print("=" * 70)
	print("LSTM RAW-ERROR-RANKING TEST SCORE GENERATION")
	print("=" * 70)
